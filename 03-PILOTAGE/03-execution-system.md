...
# MODÉLISER L EXÉCUTION COMME UN SYSTÈME
...
L’exécution est un système : intention, ordre, réponse, état final et réconciliation. Une erreur opérationnelle peut détruire une stratégie correcte.
...
**cycle de vie de l’ordre, partial fill, réconciliation, reprise et kill switch**. Ces termes sont utiles seulement lorsqu'ils permettent d'expliquer une observation.

## 3. Exemple guidé

Perdre la confirmation d’un ordre puis renvoyer aveuglément peut doubler l’exposition. Un système sérieux sait retrouver l’état avant d’agir.
...
Simule une confirmation perdue puis un redémarrage. Définis une procédure idempotente et vérifie que la position finale est cohérente.
...
Tu apprends que « stratégie » inclut le système qui l’exécute.
