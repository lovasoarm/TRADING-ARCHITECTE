...
Transfère le mécanisme de **RUNBOOKS & MONITORING** à un autre actif, un autre horizon et un problème non financier.

Pour chaque cas : invariant, changement, mesure, risque.

## Cas de transfert

Prends le concept **monitoring et réponse aux incidents** et applique-le à un objet différent de celui de l'exercice principal.
