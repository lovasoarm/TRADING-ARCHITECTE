...
Le risque d’un portefeuille ne se calcule pas en additionnant simplement des risques de trades indépendants. Les expositions communes dominent pendant certains régimes.
...
**covariance, corrélation, facteurs, concentration et exposition**. Ces termes sont utiles seulement lorsqu'ils permettent d'expliquer une observation.

## 3. Exemple guidé

Cinq positions peuvent être une seule position économique si elles dépendent du même facteur, de la même devise ou du même événement.
...
Construis quatre positions puis impose un scénario où les corrélations augmentent fortement. Mesure perte conjointe et contribution marginale.
...
Tu passes du risque local d’un trade à la structure globale de ton capital.
