...
À la sortie de **OPÉRATIONS & COMPLIANCE**, tu dois pouvoir formuler :

1. **Mécanisme** : Une stratégie rentable peut mourir d’un mauvais fichier, d’un ordre dupliqué ou d’une règle violée.
