...
Aucun contrôle unique n'est suffisant. La résilience vient des couches : permissions, limites, journalisation, réconciliation, kill switch, procédures et responsabilité claire.

## Modes de défaillance

Pour **opérations de marché**, ne mémorise pas une liste de risques : apprends à les provoquer.
