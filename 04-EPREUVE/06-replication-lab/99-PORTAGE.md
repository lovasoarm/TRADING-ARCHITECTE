...
Transfère le mécanisme de **REPLICATION LAB** à un autre actif, un autre horizon et un problème non financier.

Pour chaque cas : invariant, changement, mesure, risque.

## Cas de transfert

Prends le concept **réplication indépendante** et applique-le à un objet différent de celui de l'exercice principal.
