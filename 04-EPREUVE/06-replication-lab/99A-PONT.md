...
À la sortie de **REPLICATION LAB**, tu dois pouvoir formuler :

1. **Mécanisme** : Une affirmation devient robuste quand quelqu’un d’autre peut tenter de la reproduire et arriver à une conclusion comparable.
