...
Un postmortem utile n’efface pas l’histoire. Il conserve les faits, les hypothèses, l’impact et le contrôle qui aurait interrompu la chaîne.
...
**faits, chronologie, causalité, contrôle manquant et test de non-récidive**. Ces termes sont utiles seulement lorsqu'ils permettent d'expliquer une observation.

## 3. Exemple guidé

Dire « erreur humaine » est souvent insuffisant. Il faut demander pourquoi le système rendait cette erreur possible et pourquoi aucun garde-fou ne l’a arrêtée.
...
Rédige un postmortem sur un incident volontaire et ajoute un test de régression qui empêcherait la répétition.
...
Tu transformes l’échec en modification vérifiable plutôt qu’en récit moral.
