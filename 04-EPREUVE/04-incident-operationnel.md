...
# UNE STRATÉGIE PEUT MOURIR SANS ÊTRE MAUVAISE
...
Une stratégie peut être correcte et perdre à cause d’un incident. Il faut distinguer risque de modèle et risque de fonctionnement.
...
**incident, idempotence, fallback, réconciliation et arrêt**. Ces termes sont utiles seulement lorsqu'ils permettent d'expliquer une observation.

## 3. Exemple guidé

Une reprise automatique peut aggraver le problème. Sans état fiable, le système peut agir deux fois.
...
Simule une panne au milieu d’une séquence d’ordres. Retrouve l’état, bloque les doublons et réconcilie avant reprise.
...
Tu apprends la survie opérationnelle sans modifier l’hypothèse de marché.
