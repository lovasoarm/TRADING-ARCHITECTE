...
Une revue prestigieuse n'empêche ni erreur, ni sélection de données, ni désaccord scientifique. Le curriculum conserve le doute là où la littérature est réellement divisée.

## Modes de défaillance

Pour **lecture critique des papiers**, ne mémorise pas une liste de risques : apprends à les provoquer.
