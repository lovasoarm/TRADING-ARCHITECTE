...
# ATTRIBUER LA PERFORMANCE AVANT DE L INTERPRÉTER
...
Une performance brute est compacte. L’attribution la décompose pour éviter d’attribuer au signal ce qui vient du marché ou du levier.
...
Un portefeuille peut gagner alors que le signal n’apporte rien, simplement parce que l’exposition au marché était positive.
...
Attribue un portefeuille simulé entre marché, signal, allocation, timing et coûts. Puis écris une explication de cinq lignes.
