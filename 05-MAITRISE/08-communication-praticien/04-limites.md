...
La communication peut sur-vendre un résultat solide. Le test de qualité est brutal : la note doit rester correcte même si on retire les adjectifs et les mots prestigieux.

## Modes de défaillance

Pour **communication technique de décision**, ne mémorise pas une liste de risques : apprends à les provoquer.
