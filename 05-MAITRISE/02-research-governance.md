...
# FAIRE DE LA RECHERCHE COMME UNE ORGANISATION
...
Quand les expériences deviennent nombreuses, la mémoire n’est plus une base de données fiable. Il faut conserver les essais, les données, les raisons d’abandon et les décisions.
...
**research ledger, versions, inventaire des modèles, revue et arrêt**. Ces termes sont utiles seulement lorsqu'ils permettent d'expliquer une observation.

## 3. Exemple guidé

Sans registre, on peut redécouvrir une stratégie déjà rejetée sous un autre nom et oublier pourquoi elle avait échoué.
...
Crée dix entrées de recherche complètes. Puis demande à une personne ou à un futur toi de revoir une entrée sans voir son résultat final.
...
La gouvernance transforme une suite d’idées en programme de recherche cumulatif.
