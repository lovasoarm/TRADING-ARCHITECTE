...
À la sortie de **VALIDATION STATISTIQUE**, tu dois pouvoir formuler :

1. **Mécanisme** — Plus on cherche, plus on trouve des champions accidentels : la validation mesure la résistance, pas la beauté de la courbe.
