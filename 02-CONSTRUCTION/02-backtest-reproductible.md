...
Le backtest est une expérience historique. Pour être crédible, il doit conserver les données, les versions, les règles et les sorties.
...
**dataset figé, version, split temporel, logs et reproductibilité**. Ces termes sont utiles seulement lorsqu'ils permettent d'expliquer une observation.

## 3. Exemple guidé

Changer la règle trois fois puis ne publier que la dernière version efface l’histoire de recherche et exagère la qualité apparente.
...
Lance deux fois le même test à partir des mêmes entrées. Puis change une seule hypothèse et vérifie que le diff de sortie correspond à ce changement.
...
Tu apprends la reproductibilité comme une propriété du processus de recherche.
