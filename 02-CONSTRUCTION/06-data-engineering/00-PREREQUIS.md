...
Ce module traite **données de marché fiables**. Les mots-clés sont : OHLCV, timestamps, splits, corporate actions, qualité. Tu n'as pas besoin d'en avoir une maîtrise préalable : le parcours explique le vocabulaire au moment où il devient utile.
