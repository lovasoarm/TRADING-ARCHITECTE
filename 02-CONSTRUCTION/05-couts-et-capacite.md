...
# FAIRE ENTRER LE MONDE RÉEL DANS LE TEST
...
Une stratégie existe dans un marché où entrer et sortir coûte quelque chose. L’économie doit donc être calculée après coûts réalistes.
...
Une stratégie à faible marge par trade peut être transformée par quelques points de base de friction. La taille aussi compte : une stratégie qui fonctionne avec petit capital peut dégrader son exécution à grande échelle.
...
Refais le test avec coûts 1x, 2x, 5x et 10x. Puis multiplie progressivement la taille des positions et note le point où la performance ou l’exécution devient fragile.
...
Tu apprends à distinguer rendement de tableur et rendement économiquement accessible.
