...
Une feature sans fuite peut toujours être inutile, instable, redondante ou coûter plus cher à produire que la valeur qu'elle ajoute.

## Modes de défaillance

Pour **construction de variables explicatives**, ne mémorise pas une liste de risques : apprends à les provoquer.
