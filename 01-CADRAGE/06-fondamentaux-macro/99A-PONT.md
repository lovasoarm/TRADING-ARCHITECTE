...
À la sortie de **FONDAMENTAUX MACRO ET DÉCLENCHEURS**, tu dois pouvoir formuler :

1. **Mécanisme** — Un trader ne trade pas « l’inflation » : il trade la variation d’une variable, la surprise relative au consensus et sa transmission au prix.
