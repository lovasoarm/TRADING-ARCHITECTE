...
Un récit peut être séduisant sans être testable. Une hypothèse exploitable précise la population, la condition, l’action, l’horizon et la métrique.
...
**hypothèse falsifiable, variables, critères et invalidation**. Ces termes sont utiles seulement lorsqu'ils permettent d'expliquer une observation.

## 3. Exemple guidé

« Les cassures marchent » est trop vague. « Sur cet univers, une cassure définie ainsi modifie-t-elle la distribution des rendements sur cet horizon, après coûts ? » peut être réfuté.
...
Écris une hypothèse puis deux explications alternatives. Pour chacune, définis la mesure qui pourrait les départager.
...
Une bonne hypothèse n’a pas besoin d’être vraie ; elle doit pouvoir apprendre quelque chose lorsqu’elle échoue.
...
Harvey, Liu & Zhu (2016) sur les tests multiples ; White (2000) sur le data snooping.
