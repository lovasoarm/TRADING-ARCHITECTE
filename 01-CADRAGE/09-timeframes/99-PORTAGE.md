...
Transfère le mécanisme de **HORIZONS & TIMEFRAMES** à un autre actif, un autre horizon et un problème non financier.

Pour chaque cas : invariant, changement, mesure, risque.

## Cas de transfert

Prends le concept **horizons de décision** et applique-le à un objet différent de celui de l'exercice principal.
