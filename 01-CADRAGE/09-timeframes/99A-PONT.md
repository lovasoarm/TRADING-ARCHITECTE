...
À la sortie de **HORIZONS & TIMEFRAMES**, tu dois pouvoir formuler :

1. **Mécanisme** — Changer d’horizon change le bruit observé, les coûts relatifs, le temps de réaction et les données nécessaires.
