...
À la sortie de **FAMILLES DE STRATÉGIES**, tu dois pouvoir formuler :

1. **Mécanisme** : Une famille décrit un mécanisme d’exposition ; elle ne garantit ni alpha ni robustesse.
