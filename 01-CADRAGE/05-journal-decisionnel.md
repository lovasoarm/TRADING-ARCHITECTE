...
Un journal utile permet de reconstruire l’état du monde et de ta décision. Il doit garder l’information disponible avant le résultat.
...
**journal structuré, contexte, raison, taille, résultat et postmortem**. Ces termes sont utiles seulement lorsqu'ils permettent d'expliquer une observation.

## 3. Exemple guidé

« +20 € » ne dit pas si le trade était bon. Une bonne décision peut perdre et une mauvaise décision peut gagner.
...
Crée une table de 30 décisions avec : contexte, hypothèse, action, risque, résultat, écart au plan, contre-exemple et leçon.
...
Ton journal devient une base d’analyse et non un album de souvenirs.
...
Barber & Odean ; littérature de behavioral finance recensée dans le corpus.
