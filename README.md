...
<svg width="180" height="48" viewBox="0 0 180 48" role="img" aria-label="Trading Architecte">
  <path d="M12 36V12h24M12 24h18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
  <path d="M52 32l18-16 14 10 28-18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <circle cx="112" cy="8" r="3" fill="currentColor"/>
  <path d="M132 36h36M150 12v24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
</svg>
...
<svg width="220" height="22" viewBox="0 0 220 22" aria-hidden="true">
  <path d="M8 11h44m16 0h52m16 0h76" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
  <circle cx="60" cy="11" r="4" fill="none" stroke="currentColor" stroke-width="1.5"/>
  <circle cx="128" cy="11" r="4" fill="none" stroke="currentColor" stroke-width="1.5"/>
  <circle cx="212" cy="11" r="4" fill="none" stroke="currentColor" stroke-width="1.5"/>
</svg>
</div>
...
<svg width="200" height="28" viewBox="0 0 200 28" aria-hidden="true">
  <path d="M12 22V6h36v16M76 22V6h36v16M140 22V6h48v16" fill="none" stroke="currentColor" stroke-width="1.5"/>
  <path d="M48 14h28m36 0h28" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
</div>
