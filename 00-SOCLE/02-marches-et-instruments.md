...
# CE QUE L ON PEUT RÉELLEMENT TRADER
...
Compare une action cash avec un future indiciel. Le même mouvement de sous-jacent peut produire des profils de pertes et de financement très différents. Un dérivé ajoute des obligations que l’achat cash n’a pas.
...
Choisis trois instruments et remplis une fiche : ce que tu possèdes, ce qui déclenche la marge, comment tu sors, quels coûts existent et quel événement peut conduire à une liquidation.
...
Tu sais maintenant choisir un objet de marché avant de parler de stratégie.
