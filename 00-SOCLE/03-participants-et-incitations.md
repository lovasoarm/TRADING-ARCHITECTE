...
# QUI AGIT SUR LE MARCHÉ ET POURQUOI
...
**retail, market maker, dealer, hedge fund, hedger et arbitragiste**. Ces termes sont utiles seulement lorsqu'ils permettent d'expliquer une observation.

## 3. Exemple guidé

Un mouvement de prix n’a pas une seule cause. La même hausse peut résulter d’une information, d’un rééquilibrage, d’une couverture ou d’un retrait de liquidité. Le récit « les gros ont fait ça » est souvent plus simple que la réalité.
...
Prends un mouvement et construis trois histoires concurrentes avec acteurs, contraintes, horizons et actions possibles. Puis indique quelles observations permettraient de les départager.
...
Tu remplaces une explication anthropomorphique par un ensemble d’hypothèses testables.
