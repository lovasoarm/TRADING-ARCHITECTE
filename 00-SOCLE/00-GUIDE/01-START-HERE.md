...
Q2. Pourquoi un trade gagnant ne prouve-t-il rien à lui seul ?
Q3. Quel type de perte pourrait tuer une stratégie ?
Q4. Quel mot de trading te paraît le plus opaque ?
```
...
```text
information → décision → ordre → exécution → résultat
```
...
`terme → français simple → analogie → limite de l'analogie`.

## Ce que tu dois obtenir

Pas une stratégie. Pas un signal. Une **carte mentale fonctionnelle**.
