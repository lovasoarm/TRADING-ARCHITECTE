...
Une étape est validée par une **preuve**, pas par la lecture.
...
- Dernière preuve :
- Question ouverte :
- Risque principal observé :
- Mot que je ne sais pas encore expliquer :
...
00-SOCLE / PROLOGUE
   ↓
00-SOCLE / REFERENTIEL
   ↓
00-SOCLE / FUNDAMENTALS
   ↓
00-SOCLE / PROBLEM-SOLVING
   ↓
00-SOCLE / CORE
   ↓
01 CADRAGE
...
```text
PREREQUIS → LEÇON → PRÉDICTION → PRATIQUE → LIVRABLE → CHALLENGE → BOSS → PORTAGE → PONT
```

## Règle d'or

Ne coche pas « lu ». Coche seulement ce que tu peux **refaire, expliquer, défendre et transférer**.
